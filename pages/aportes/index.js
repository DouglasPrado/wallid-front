    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <main className="flex flex-col items-center justify-around w-full flex-1 text-center ">
        <div className="flex flex-col items-center p-3 w-full">
          ...
          <label className="w-full mb-2 text-left">
            <span className="text-sm text-gray-700">Aportes da conta</span>
            <input name="value_in_cents" type="number" className="form-input px-4 py-2 rounded w-full" />
          </label>
          <button type="submit" className="flex justify-center mt-2 py-3 bg-green-600 text-gray-50 w-full rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
              </svg>
              <span className="uppercase">Aportar</span>
          </button>
        </div>
